...
class ProjectLayout extends React.Component {
  static propTypes = {
    selectedDirData: PropTypes.object,
  ...
  shouldComponentUpdate (nextProps, nextState, nextContext) {
    ...
    return notification !== nextProps.notification || showCentralPanelCover !== nextState.showCentralPanelCover;
  }
  ...
  componentDidMount () {
    this.props.onMounted(this.props.selectedDirData.selectedDirPath);
  }
