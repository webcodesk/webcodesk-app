module.exports = {
  ...
  URL_WEBCODESK_ISSUE_TRACKER: 'https://github.com/webcodesk/webcodesk/issues',
  URL_WEBCODESK_USER_GUIDE: 'https://webcodesk.com/documentation',

  CURRENT_CREATE_REACT_APP: 'create-react-app@2.1.8',
  CURRENT_WEBCODESK_REACT_SCRIPTS: '@webcodesk/react-scripts@2.1.11',
  CURRENT_REACT_SCRIPTS_VERSION: '2.1.8',
  CURRENT_CROSS_ENV_VERSION: '5.2.0',

  NEW_PROJECT_JAVA_SCRIPT_TYPE: 'NEW_PROJECT_JAVA_SCRIPT_TYPE',
  NEW_PROJECT_TYPE_SCRIPT_TYPE: 'NEW_PROJECT_TYPE_SCRIPT_TYPE',
  ...
  REACT_SCRIPTS_NAME: '@webcodesk/react-scripts',
  ...
  RESOURCE_IN_COMPONENT_STORIES_TYPE: 'RESOURCE_IN_COMPONENT_STORIES_TYPE',
  ...
  COMPONENT_NAME_VALID_REGEXP: new RegExp(/^[\w]*$/),
  USER_FUNCTION_NAME_VALID_REGEXP: new RegExp(/^[\w]*$/),
  FILE_NAME_VALID_REGEXP: new RegExp(/^(?!\/)[\w_]*$/),
  FILE_PATH_VALID_REGEXP: new RegExp(/^(?!\/)[\w_/]*$/),
  ...
  GRAPH_MODEL_COMPONENT_STORIES_ROOT_KEY: 'GRAPH_MODEL_COMPONENT_STORIES_ROOT_KEY',
  ...
  GRAPH_MODEL_COMPONENT_STORIES_ROOT_TYPE: 'GRAPH_MODEL_COMPONENT_STORIES_ROOT_TYPE',
  ...
  GRAPH_MODEL_COMPONENT_STORIES_TYPE: 'GRAPH_MODEL_COMPONENT_STORIES_TYPE',
  GRAPH_MODEL_PAGE_TYPE: 'GRAPH_MODEL_PAGE_TYPE',
  GRAPH_MODEL_COMPONENT_PROPERTY_FUNCTION_TYPE: 'GRAPH_MODEL_COMPONENT_PROPERTY_FUNCTION_TYPE',
  GRAPH_MODEL_COMPONENT_PROPERTY_OBJECT_TYPE: 'GRAPH_MODEL_COMPONENT_PROPERTY_OBJECT_TYPE',
  GRAPH_MODEL_COMPONENT_PROPERTY_ELEMENT_TYPE: 'GRAPH_MODEL_COMPONENT_PROPERTY_ELEMENT_TYPE',
  ...
  // do not chane values - they are used in flow etc files
  PAGE_COMPONENT_TYPE: 'pageComponent',
  ...
  INDEX_COMPONENT_STORIES_ROOT_DIR_NAME: 'userComponentStories',
